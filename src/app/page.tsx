...
export default function Home() {
  const steps = [
    ...
    },
    {
      ...
      image: "/TabGroups.png",
      description:
        "Create new Workspaces to seperate your Browsing stuff in spaces to boost productivity  ",
      instructions: [
        "Open the Workspace panel from the sidebar",
        "Create new Workspace",
        "add new Tabs to your Workspaces",
        "switch between workspaces to boost productivity ",
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-zinc-950 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Floating browser window structures */}
        <div className="absolute top-20 right-1/4 w-64 h-40 bg-gradient-to-br from-zinc-800/30 to-zinc-900/50 rounded-lg border border-indigo-500/20 backdrop-blur-sm animate-float-slow">
          <div className="h-8 bg-gradient-to-r from-zinc-700/50 to-zinc-800/50 rounded-t-lg border-b border-indigo-500/10 flex items-center px-3 gap-2">
        ...
        <div className="absolute top-1/3 left-16 w-48 h-32 bg-gradient-to-br from-zinc-800/20 to-zinc-900/40 rounded-lg border border-indigo-400/15 backdrop-blur-sm animate-float-reverse">
          <div className="h-6 bg-gradient-to-r from-zinc-700/40 to-zinc-800/40 rounded-t-lg border-b border-indigo-400/10 flex items-center px-2 gap-1">
        ...
        {/* Geometric shapes */}
        <div className="absolute top-1/2 right-20 w-32 h-32 border border-indigo-500/10 rotate-45 animate-spin-slow"></div>
        <div className="absolute bottom-1/4 left-1/3 w-24 h-24 border-2 border-zinc-600/20 rounded-full animate-pulse"></div>
        ...
        {/* Floating particles */}
        <div className="absolute top-1/4 left-1/2 w-2 h-2 bg-indigo-400/30 rounded-full animate-float-particle"></div>
        <div className="absolute top-3/4 right-1/3 w-1 h-1 bg-zinc-400/40 rounded-full animate-float-particle-reverse"></div>
        <div className="absolute bottom-1/3 left-1/4 w-1.5 h-1.5 bg-indigo-300/25 rounded-full animate-float-slow"></div>
      </div>
      ...
      <section className="pb-20 bg-zinc-950 relative overflow-hidden w-full">
        <div className="mb-20 pb-20">
          <div className="flex justify-center">
            <div className="p-6 bg-zinc-900 rounded-2xl  w-[64vw]   hover:border-indigo-500/30 transition-all duration-500 hover:shadow-xl hover:shadow-indigo-500/50 hover:-translate-y-2">
              <img src="Browserinterface3.png" className="" alt="" />
            </div>
          </div>
        </div>
      ...
      <section className="py-22 bg-zinc-950 relative">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-1/2 -left-32 w-64 h-64 bg-gradient-to-r from-zinc-800/30 to-zinc-900/50 rounded-full blur-xl"></div>
        </div>
